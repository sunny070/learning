<x-app-layout>
    ...
    <div class="py-12">
        <div class="flex justify-evenlymax-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white w-[500px] overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    {{-- <div class="overflow-x-auto sm:-mx-6 lg:-mx-8"> --}}
                        ...
                        <div class="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-3 gap-5"> 
            ...
            <div class="py-12">
                ...
                <div class="flex justify-start first-letter:max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div
