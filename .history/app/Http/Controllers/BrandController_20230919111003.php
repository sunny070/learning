...
class BrandController extends Controller
{
    ...
    public function StoreBrand(Request $request)
    {
        ...
        //An id will be generated then . then the extension  Eg:123123123123.jpg
        // Image::make($brand_image)->resize(300,200)->save('image/brand/'.$name_generate);
        Image::make($brand_image)
            ->resize(300, 200)
            ->save('image/brand/' . $name_generate);
    ...
    public function StoreMultiPicture(Request $request)
    {
        ...
        Image::make($image)
            ->resize(300, 200)
            ->save('image/multi/' . $name_generate);
