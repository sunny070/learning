        ...
        <div class="flex max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="py-12">
                ...
                <div class="flex justify-center max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class=" bg-white w-full h-full overflow-hidden shadow-xl sm:rounded-lg">
                        @if(session('success'))
                    <div id="alert-1"
                            ...
                            <div class="">
                                <div class="mb-6">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="brand_name">Update Brand Name</label>
                                    <input
                                        class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                        aria-describedby="brand_name_help" value="{{ $brand->brand_name }}" name="brand_name" id="brand_name" type="text">
                                ...
                                <div class="mb-6">
                                    ...
                                    <input
                                        class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                        aria-describedby="brand_image_help" value="{{ $brand->brand_image }}" name="brand_image" id="brand_image" type="file">
